...
class SwopClientTest {
  ...
  private SwopClientProperties properties;
  ...
  void setUp() throws IOException {
    ...
    properties = new SwopClientProperties();
  ...
  void shouldFetchRateFromSwop() throws InterruptedException {
    ...
    SwopClient client = new SwopClient(properties);
    SwopRateResponse response = client.fetchRate("EUR", "USD");
